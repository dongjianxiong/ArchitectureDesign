...
if [[ "$CONFIGURATION" == "Bate" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LNUserCenterModule/LNUserCenterModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LNVideoModule/LNVideoModule.framework"

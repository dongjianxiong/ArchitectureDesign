...
- (void)show
{
    ...
    // 发出通知
    userInfo[PYBigImageDidClickedNotification] = selectedPhotoView;
    userInfo[PYPhotoBrowseViewKey] = self;
    NSNotification *notification = [[NSNotification alloc] initWithName:PYBigImageDidClickedNotification object:self.photosView userInfo:userInfo];
...
- (void)hidden
{
    ...
    NSNotificationCenter *center = [NSNotificationCenter defaultCenter];
    NSMutableDictionary *userInfo = [NSMutableDictionary dictionary];
    userInfo[PYSmallgImageDidClickedNotification] = selectedPhotoView;
    NSNotification *notification = [[NSNotification alloc] initWithName:PYSmallgImageDidClickedNotification object:self.photosView userInfo:userInfo];
    [center postNotification:notification];
}
...
- (void)didSingleClick:(PYPhotoView *)photoView
{
    ...
    NSMutableDictionary *userInfo = [NSMutableDictionary dictionary];
    // 缩小
    userInfo[PYSmallgImageDidClickedNotification] = photoView;
    NSNotification *notification = [[NSNotification alloc] initWithName:PYSmallgImageDidClickedNotification object:self.photosView userInfo:userInfo];
    [center postNotification:notification];
